package com.herb.example.api.rest;

import com.herb.example.exception.rest.ResourceNotFoundException;
import com.herb.example.domain.RestErrorInfo;
import com.herb.example.exception.rest.DataFormatException;
...
public abstract class AbstractRestHandler implements ApplicationEventPublisherAware {
    ...
    RestErrorInfo handleDataStoreException(DataFormatException ex, WebRequest request, HttpServletResponse response) {
        ...
        return new RestErrorInfo(ex, "Invalid data. Check your data format.");
    }
